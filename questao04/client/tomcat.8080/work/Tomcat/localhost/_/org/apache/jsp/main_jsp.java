 ...
 * Generated at: 2018-04-18 03:59:51 UTC
...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <span class=\"time-left\" style=\"color: red\">{{message.nickname}}</span><br>\n");
      ...
      out.write("//            Vue.http.options.xhr = {withCredentials: true};\n");
      out.write("//            Vue.http.headers.common['Access-Control-Allow-Credentials'] = 'true';\n");
      out.write("//            Vue.http.headers.common['Access-Control-Allow-Origin'] = 'http://localhost:8081/user-rs/user/all';\n");
      out.write("//            Vue.http.headers.common['Access-Control-Request-Method'] = '*';\n");
      out.write("            Vue.http.get('http://localhost:8081/user-rs/user/all').then(res => {\n");
      out.write("                console.log(vm_user.users);\n");
      out.write("                console.log(res.body);\n");
      ...
      out.write("//            Vue.http.headers.common['Access-Control-Allow-Origin'] = '*';\n");
      out.write("//            Vue.http.headers.common['Access-Control-Allow-Origin'] = 'http://xxx.xxx.xxx.xxx:94';\n");
      out.write("//            Vue.http.headers.common['Access-Control-Allow-Origin'] = 'http://localhost:8083/message-rs/message/all';\n");
      out.write("            Vue.http.get('http://localhost:8083/message-rs/message/all').then(res => {\n");
      out.write("                console.log(vm_ms.messages);\n");
      out.write("                console.log(res.body);\n");
